...
<div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
         ...
         <li><a class="w3-text-white w3-hover-text-yellow" href="<c:url value="/" /> "><span class="glyphicon glyphicon-home"></span>Home</a></li>
          <li><a class="w3-text-white w3-hover-text-orange" href="<c:url value="/product/productList/all" />"><span class="glyphicon glyphicon-eye-open"></span>Products</a></li>
          <li><a class="w3-text-white w3-hover-text-blue" href="<c:url value="/about" />"><span class="glyphicon glyphicon-file"></span>About Us</a></li> 
    ...
    <c:if test="${pageContext.request.userPrincipal.name != null}">
                           ...
                           <c:if test="${pageContext.request.userPrincipal.name != 'admin'}">
                            ...
                            <c:if test="${pageContext.request.userPrincipal.name != 'admin' }">
                              <li><a href ="<c:url value="/customer/cart"/>"></a></li>
                            </c:if> 
                        </c:if>
                        <c:if test="${pageContext.request.userPrincipal.name  == null}">
